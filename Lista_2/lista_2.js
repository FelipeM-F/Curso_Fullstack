...
console.log("1. Calcular a redução do tempo de vida de um fumante");
console.log("2. Calcular multa por excesso de velocidade");
console.log("3. Calcular o preço da passagem");
console.log("4. Verificar se três lados podem formar um triângulo");
console.log("5. Jogar JoKenPo");
console.log("6. Jogo de sorteio de número");
console.log("7. Calcular preço do aluguel de carro");
console.log("8. Calcular pontos e dinheiro ganhos por atividades físicas");
console.log("9. Calcular total de salários pagos a homens e mulheres");
console.log("10. Somatório, menor valor, média e quantidade de pares de vários números");
console.log("11. Mostrar os 10 primeiros elementos de uma PA e sua soma");
console.log("12. Mostrar os 10 primeiros elementos da sequência de Fibonacci");
console.log("13. Preencher um vetor com os primeiros 15 elementos da sequência de Fibonacci");
console.log("14. Ler 7 nomes e mostrá-los na ordem inversa");
console.log("15. Mostrar números pares e suas posições de um vetor de 10 números");
console.log("16. Preencher um vetor com 20 números aleatórios e ordená-lo");
console.log("17. Listar nomes e idades de menores de idade de um grupo de 9 pessoas");
console.log("18. Registrar e mostrar informações de um funcionário");
console.log("19. Ler e validar 5 horários no formato HH.MM.SS");
console.log("20. Emitir contracheque para 80 funcionários com cálculo de INSS");
console.log("21. Calcular peso ideal baseado em altura e sexo");
console.log("22. Pesquisa de salários e número de filhos, retornando várias estatísticas");
console.log("23. Criar e imprimir a matriz identidade de 7x7");
console.log("24. Contar elementos negativos de cada linha de uma matriz 6x8 e armazenar em um vetor");
console.log("25. Somar os elementos de cada coluna de uma matriz 15x20");
console.log("26. Calcular a matriz produto de duas matrizes 3x5");
console.log("27. Multiplicar uma matriz 6x6 por um valor e armazenar o resultado em um vetor");
console.log("28. Somar elementos acima e abaixo da diagonal principal de uma matriz 10x10");
console.log("29. Somar linha, coluna, diagonal e todos os elementos de uma matriz 5x5");
console.log("30. Criar vetores com as somas das linhas e colunas de uma matriz 5x5");
console.log("31. Contar valores iguais a A em uma matriz 30x30 e criar uma nova matriz sem esses valores");
console.log("32. Dividir elementos de cada linha de uma matriz 12x13 pelo maior elemento daquela linha");
console.log("33. Multiplicar elementos da diagonal principal de uma matriz 3x3 pela média da diagonal secundária");
console.log("34. Multiplicar cada linha de uma matriz 50x50 pelo elemento da diagonal principal daquela linha");
console.log("35. Separar 30 valores em vetores de pares e ímpares, escrevendo-os quando cheios");
console.log("36. Verificar acertos de 100 apostadores em um teste da loteria esportiva");
console.log("37. Contar acertos dos alunos em um teste e classificá-los como APROVADO ou REPROVADO");
console.log("38. Operações diversas (soma, produto, média, ordenação) em um vetor de 6 elementos");
console.log("39. Compactar um vetor de 100 posições removendo valores nulos e negativos");
console.log("40. Verificar apostas de 50 conjuntos contra o resultado oficial da Loto");
console.log("41. Acessar e imprimir idade de um objeto pessoa e adicionar propriedade email");
console.log("42. Retornar um novo objeto apenas com as propriedades que são arrays de um objeto dados");
console.log("43. Combinar propriedades de dois objetos com precedência para o segundo");
console.log("44. Contar e retornar o número de propriedades string em um objeto");
console.log("45. Contar ocorrências de strings em um array e armazenar em um objeto");
console.log("46. Sumarizar o total de vendas por vendedor a partir de um array de vendas");
console.log("47. Transformar um objeto aplicando uma função a cada uma de suas propriedades");
console.log("48. Combinar inventários de duas lojas somando quantidades de itens repetidos");
console.log("49. Categorizar transações financeiras e calcular subtotais por categoria");
console.log("50. Sistema de reserva de hotéis com várias funcionalidades");

let escolha = parseInt(prompt("Digite o número do exercício: "));
...
{   // 48. Você recebe dois objetos que representam o inventário de duas lojas diferentes:
    ...
    console.log('Novo inventário: ', combinarInventarios(inventarioLojaA, inventarioLojaB));
}break;
...
{   // 50. Desenvolva um pequeno sistema de reserva de hotéis usando JavaScript. O sistema
    ...
    function adicionarHotel(listaHoteis) {
        let hotel = {};
        hotel.id = listaHoteis[listaHoteis.length-1].id + 1;
        hotel.nome = prompt('Nome do hotel: ');
        hotel.cidade = prompt('Cidade do hotel: ');
        hotel.quartosTotais = Number(prompt('Quartos totais: '));
        hotel.quartosDisponiveis = hotel.quartosTotais;
        hotel.avaliacoes = null
        listaHoteis.push(hotel);
        return listaHoteis;
    }

    function buscarHoteisPorCidade(listaHoteis, cidade) {
        let hoteisPorCidade = [];
        listaHoteis.forEach(hotel => {
            if (hotel.cidade.toLowerCase() === cidade.toLowerCase()) {
                hoteisPorCidade.push(hotel);
            }
        })
        if(hoteisPorCidade.length === 0) {
            
            return 'Nenhum hotel encontrado na cidade informada'
        }
        return hoteisPorCidade;
    }

    function fazerReserva(nomeHotel, listaHoteis, listaReservas) {
        let hotel = listaHoteis.find(hotel => hotel.nome.toLowerCase() === nomeHotel.toLowerCase());
        console.log(hotel);
        if (hotel === undefined) {
        ...
        if (hotel.quartosDisponiveis > 0) {
            let reserva = {};
            reserva.idReserva = hotel.id+'-'+(parseInt(listaReservas[listaReservas.length-1].idReserva.split('-').pop()) + 1);
            reserva.idHotel = hotel.id;
            reserva.nomeCliente = prompt('Nome do cliente: ');
        ...
        console.log('Sem quartos disponíveis');
    }

    function cancelarReserva(idReserva, listaHoteis, listaReservas) {
        let reserva = listaReservas.find(reserva => reserva.idReserva === idReserva);
        if (reserva === undefined) {
            return 'Reserva não encontrada';
        }
        let hotel = listaHoteis.find(hotel => hotel.id === reserva.idHotel);
        hotel.quartosDisponiveis++;
        listaReservas.splice(listaReservas.indexOf(reserva), 1);
        return 'Reserva Cancelada';
    }

    function checkIn(idReserva, listaReservas) {
        let reserva = listaReservas.find(reserva => reserva.idReserva === idReserva);
        if (reserva === undefined) {
            return 'Reserva não encontrada';
        }
        reserva.checkIn = true;
        return 'Check-in efetuado';
    }

    function checkOut(idReserva, listaReservas) {
        let reserva = listaReservas.find(reserva => reserva.idReserva === idReserva);
        if (reserva === undefined || reserva.checkIn === false) {
            console.log('Reserva ainda não foi confirmada');
        };
        reserva.checkOut = true;
        return 'Check-out efetuado';
    }

    function avaliarHotel(idHotel, listaHoteis) {
        let hotel = listaHoteis.find(hotel => hotel.id === idHotel);
        console.log(hotel.avaliacoes);
        let avaliarHotel = parseFloat(prompt('Avalie o hotel de 1 a 5 ou digite 0 para cancelar: '));
        if(avaliarHotel < 1 || avaliarHotel > 5 || isNaN(avaliarHotel)) {
            console.log('Avaliação inválida');
            avaliarHotel(hotel, listaHoteis);
        }
        console.log('Avaliação registrada com sucesso', hotel.avaliacoes);
        hotel.avaliacoes = parseFloat(((hotel.avaliacoes+avaliarHotel)/2).toFixed(1));
        return listaHoteis;

    }

    function taxaDeOcupacao(listaHoteis) {
        let totalQuartos = 0;
        let totalQuartosDisponiveis = 0;
        let taxaDeOcupacao = {}
        listaHoteis.forEach(hotel => {
            totalQuartos = hotel.quartosTotais;
            totalQuartosDisponiveis = hotel.quartosDisponiveis;
            taxaDeOcupacao[hotel.nome] = ((totalQuartosDisponiveis / totalQuartos).toFixed(2)*100)+'%';
        });
        return taxaDeOcupacao;
    }

    let listaHoteis = [
        { id: 1, nome: "Hotel A", cidade: "Cidade A", quartosTotais: 100, quartosDisponiveis: 20, avaliacoes: 4.5},
        { id: 2, nome: "Hotel B", cidade: "Cidade B", quartosTotais: 80, quartosDisponiveis: 10, avaliacoes: 4.0 },
        { id: 3, nome: "Hotel C", cidade: "Cidade C", quartosTotais: 50, quartosDisponiveis: 5, avaliacoes: 5.0 },
        { id: 30, nome: "Hotel D", cidade: "Cidade C", quartosTotais: 50, quartosDisponiveis: 5, avaliacoes: 4.5}
    ];

    let listaReservas = [
        { idReserva: '1-1', idHotel: 1, nomeCliente: "Joaquim", checkIn: true, checkOut: false },
        { idReserva: '2-2', idHotel: 2, nomeCliente: "Maria", checkIn: false, checkOut: false },
        { idReserva: '3-3', idHotel: 3, nomeCliente: "Pedro", checkIn: false, checkOut: false }
    ];

    function administrarHoteis(listaHoteis,listaReservas) {
        let operacao = 0;
        console.log(listaHoteis);
        do {
            console.log('Menu: \n 1 - Adicionar hotel \n 2 - Buscar hoteis por cidade \n 3 - Fazer reserva \n 4 - Cancelar reserva \n 5 - Listar reservas \n 6 - Check-in \n 7 - Check-out \n 8 - Listar Hoteis \n 9 - Taxa de Ocupação \n 10 - Sair');
            operacao = prompt('Operação desejada: ');
            let idReserva = 0;
            switch (operacao) {
                case '1':
                    adicionarHotel(listaHoteis);
                    break;
                case '2':
                    let nomeCidade = prompt('Cidade: ');
                    let hoteisPorCidade = buscarHoteisPorCidade(listaHoteis, nomeCidade);
                    console.log(hoteisPorCidade);
                    break;
                case '3':
                    let nomeHotel = prompt('Nome do hotel: ');
                    let reserva = fazerReserva(nomeHotel, listaHoteis, listaReservas);
                    console.log(reserva);
                    break;
                case '4':
                    idReserva = prompt('ID da reserva: ');
                    let cancelar = cancelarReserva(idReserva, listaHoteis, listaReservas);
                ...
                case '6':
                    idReserva = prompt('ID da reserva: ');
                    let chkIn = checkIn(idReserva, listaReservas);
                    console.log(chkIn);
                    break;
                case '7':
                    idReserva = prompt('ID da reserva: ');
                    let chkOut= checkOut(idReserva, listaReservas);
                    avaliarHotel(listaReservas[listaReservas.findIndex(reserva => reserva.idReserva === idReserva)].idHotel, listaHoteis);
                    console.log(chkOut);
                    break;
                case '8':
                    console.log(listaHoteis);
                    break;
                case '9':
                    console.log(taxaDeOcupacao(listaHoteis));
                    break
                case '10':
                    break;
                default:
    ...
    administrarHoteis(listaHoteis, listaReservas);
