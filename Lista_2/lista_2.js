...
console.log("23. Criar e imprimir a matriz identidade");
console.log("24. Contar elementos negativos de cada linha de uma matriz e armazenar em um vetor");
console.log("25. Somar os elementos de cada coluna de uma matriz 15x20");
console.log("26. Calcular a matriz produto de duas matrizes");
