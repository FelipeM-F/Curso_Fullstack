...
import generateJwtToken from '../services/JwtTokenGenerator';
...
const Login = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (username === 'admin' && password === 'password') {
      const token = await generateJwtToken(); // Gera o token JWT
      onLogin(token); // Chama a função onLogin passada como prop e envia o token
    } else {
