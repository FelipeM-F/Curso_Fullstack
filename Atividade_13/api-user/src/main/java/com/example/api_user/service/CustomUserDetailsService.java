...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        UserDetails userDetails = org.springframework.security.core.userdetails.User
                .withUsername(user.getUsername()) // Define o userId como username
                .password(user.getPassword()) // Define a senha (criptografada) do usuário
                .authorities(user.getRole()) // Define as roles
                .build();
        CustomUserDetails CustomUser =new CustomUserDetails(user.getId(),userDetails);
        return CustomUser;
    }
